...
const arrowSVGs: JSX.Element[] = [
  ...
  <svg
    ...
    y='0px'
    viewBox='0 0 100 100'
    // style='enable-background:new 0 0 458.079 458.079;'
    // xml:space='preserve'
    width='100'
    height='100'
    transform='matrix(-1,1.2246467991473532e-16,-1.2246467991473532e-16,-1,0,0) translate(-15, -1)'
  >
    <g>
      <path d='m98.156 47.611 -15.018 -7.123c-0.628 -0.298 -1.155 -0.443 -1.613 -0.443 -0.633 0 -1.151 0.288 -1.421 0.789 -0.538 0.999 0.243 2.182 0.499 2.571l1.83 2.774h-20.178c-0.809 -1.493 -2.09 -2.442 -3.56 -2.442 -1.107 0 -2.107 0.538 -2.879 1.441 -0.772 -0.903 -1.772 -1.441 -2.879 -1.441s-2.107 0.538 -2.879 1.441c-0.772 -0.903 -1.772 -1.441 -2.879 -1.441 -1.47 0 -2.751 0.949 -3.56 2.442h-14.699c-2.853 -2.097 -7.185 -4.617 -12.22 -5.31l-0.154 -0.011a1.137 1.137 0 0 0 -1.03 0.666c-0.192 0.42 -0.126 0.912 0.167 1.25 1.254 1.452 4.69 5.339 4.723 5.375a2.72 2.72 0 0 1 0.674 1.833v0.027a2.72 2.72 0 0 1 -0.673 1.832c-0.036 0.04 -3.56 4.037 -4.753 5.41 -0.29 0.331 -0.358 0.809 -0.172 1.219a1.135 1.135 0 0 0 1.031 0.669l0.152 -0.01c5.047 -0.685 9.391 -3.208 12.25 -5.31h14.705c0.809 1.493 2.09 2.442 3.56 2.442 1.107 0 2.107 -0.538 2.879 -1.441 0.772 0.903 1.772 1.441 2.879 1.441s2.107 -0.538 2.879 -1.441c0.772 0.903 1.772 1.441 2.879 1.441 1.47 0 2.751 -0.949 3.56 -2.442h20.178l-1.83 2.774c-0.257 0.389 -1.037 1.572 -0.499 2.571 0.27 0.501 0.788 0.789 1.421 0.789 0.458 0 0.985 -0.145 1.613 -0.443l15.018 -7.123c1.605 -0.761 1.844 -1.824 1.844 -2.389s-0.24 -1.628 -1.844 -2.389'></path>
      <path d='M7.925 42.214c-0.398 -0.434 -0.841 -0.525 -1.141 -0.525 -0.32 0 -0.566 0.104 -0.693 0.158C1.057 43.679 0 47.291 0 49.998c0 2.786 1.115 6.482 6.426 8.268a1.288 1.288 0 0 0 0.41 0.067c0.399 0 0.771 -0.179 1.048 -0.505 1.478 -1.737 6.029 -6.865 6.225 -7.085 0.376 -0.427 0.369 -1.062 -0.018 -1.511 -0.76 -0.878 -4.627 -5.341 -6.167 -7.018'></path>
    </g>
  </svg>,
  ...
  <svg
    ...
    width='100'
    height='100'
    transform='matrix(-1,0,0,1,0,0) translate(-15, 1)'
  >
  ...
  <svg
    ...
    // xml:space='preserve'
    transform='scale(-1 1) translate(-15, 1)'
    width='100'
    height='100'
  >
...
377.573,164.706 	'
  ...
  <svg
    ...
    version='1.1'
    // xmlns:xlink='http://www.w3.org/1999/xlink'
    transform='scale(-1 1) rotate(-45 -13 38)'
  >
    <path
      fill='#000'
